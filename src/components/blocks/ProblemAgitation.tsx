...
export function ProblemAgitation() {
  return (
    <section className="py-24 md:py-32 bg-primary">
      <div className="max-w-[720px] mx-auto px-6 text-center lg:text-left flex flex-col items-center lg:items-start">
        
        <h2 className="text-[32px] md:text-[48px] font-bold leading-tight mb-6">
          You didn&apos;t start this company to chase developers.
        </h2>
        
        <p className="text-[18px] text-muted mb-10 text-center lg:text-left w-full">
        ...
        <p className="text-[24px] font-bold text-white w-full text-center lg:text-left">
