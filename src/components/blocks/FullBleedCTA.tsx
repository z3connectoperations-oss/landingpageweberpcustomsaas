  ...
  return (
    <section className="min-h-[60vh] py-24 md:py-32 w-full bg-gradient-to-br from-accent to-accent-hover text-[#0A0A0A] flex flex-col items-center justify-center text-center px-6">
      <div className="max-w-[640px] w-full flex flex-col items-center">
        ...
        <Button variant="inverted" className="mb-6 px-10 h-16 w-full sm:w-auto text-[18px]">
          Let's build your product &rarr;
        </Button>

        <p className="text-[14px] text-muted/80 max-w-md mx-auto leading-relaxed border-t border-white/10 pt-4 mt-2">
